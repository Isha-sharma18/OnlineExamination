...
$score = $user->getscore($eid, $email);


$rowcount=mysqli_num_rows($score);	
if($rowcount == 0){
...
$sn=@$_GET['n'];
$total=@$_GET['t'];
$result = $user->getQuestions($eid, $sn);
...
$result = $user->getHistory($eid, $email);
...
if(@$_GET['q']== 2) 
{
  $result = $user->getHistoryFromEmail($email);
...
$result = $user->getquiz_title($email);
...
$result = $user->getUserFromEmail($e); 
while($row=mysqli_fetch_array($result) )
{
$name=$row['name'];
$gender=$row['gender'];
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/isha.jpg" width=100 height=100 alt="isha" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a  style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Isha Sharma</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 9999999999</h4>
		<h4 style="font-family:'typo' ">isha1826@gmail.com</h4>
		<h4 style="font-family:'typo' ">Kellton Tech</h4></div></div>
		</p>
      </div>
